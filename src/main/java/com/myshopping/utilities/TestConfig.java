...
public class TestConfig{
	...
	public static String from = "phamlan09111993@gamil.com";
	public static String password = "tlin oexj vyif mvxn";
	public static String[] to ={"nametesting12345@outlook.com"};
